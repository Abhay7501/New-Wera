                ...
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="pin mt-3 flex space-x-3">
                            ...
                            <button onClick={checkservice} className='flex ml-auto text-white bg-slate-500 border-0 py-2 px-6 focus:outline-none hover:bg-slate-600 rounded'>Check</button>
                        </div>
                        {!service && service != null && <div className="text-red-900">Pin Not Foubd</div>}
                        {(service && service != null) && <div className="text-green-800">Success!</div>}
                    </div>
                </div>
            </div>
        </section>
